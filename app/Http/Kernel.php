...
class Kernel extends HttpKernel {
    ...
    protected $routeMiddleware = [
        ...
        'confirmation_token.expired' =>
            \CreatyDev\Http\Middleware\ChecksExpiredConfirmationTokens::class,
        'role' => \CreatyDev\Http\Middleware\AbortIfHasNoRole::class,
        'permission' =>
            \CreatyDev\Http\Middleware\AbortIfHasNoPermission::class,
        'auth.register' =>
            \CreatyDev\Http\Middleware\AuthenticateRegister::class,
        'subscription.active' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfNotActive::class,
        'subscription.notcancelled' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfCancelled::class,
        'subscription.cancelled' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfNotCancelled::class,
        'subscription.customer' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfNotCustomer::class,
        'subscription.inactive' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfNotInactive::class,
        'subscription.team' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfNoTeamPlan::class,
        'subscription.owner' =>
            \CreatyDev\Http\Middleware\Subscription\RedirectIfNotSubscriptionOwner::class
    ];
}
