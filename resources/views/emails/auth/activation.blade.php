  ...
  <mj-body background-color="#dbe5ea">
    ...
    <mj-section background-color="#126de5" padding="16px 8px 16px 8px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px">
        <mj-text align="center" font-size="30px" line-height="36px" padding-bottom="12px" color="#fff" font-weight="bold">Account Activation</mj-text>
        <mj-text align="center" font-size="19px" line-height="28px" color="#EEE">Hello,
          Thank you for signing up.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#fff" padding="16px 24px 16px 24px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px 0px">
        <mj-text align="center" font-size="18px" line-height="24px" padding-bottom="8px" color="#242b3d" font-weight="bold">Please activate your account to get started</mj-text>
