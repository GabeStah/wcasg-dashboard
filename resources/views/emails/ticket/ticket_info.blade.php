  ...
  <mj-body background-color="#dbe5ea">
    ...
    <mj-section background-color="#126de5" padding="16px 8px 16px 8px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px">
        <mj-text align="center" font-size="30px" line-height="36px" padding-bottom="12px" color="#fff" font-weight="bold">Support Ticket Information</mj-text>
    ...
    <mj-section background-color="#fff" padding="16px 24px 16px 24px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px 0px">
        <mj-text align="center" font-size="16px" line-height="24px" color="#424651"> Thank you {{ ucfirst($user->name) }} for contacting our support team. A support ticket has been opened for
          you. You will be notified by email when we've responded. The details of your ticket are shown below:</mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#fff" padding="16px 24px 16px 24px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px 0px">
        <mj-text align="center" font-size="18px" line-height="24px" padding-bottom="8px" color="#242b3d" font-weight="bold">Ticket Information</mj-text>
        <mj-text align="center" font-size="16px" line-height="24px" color="#424651">Title: {{ $ticket->title }}</mj-text>
        <mj-text align="center" font-size="16px" line-height="24px" color="#424651">Priority: {{ $ticket->priority }}</mj-text>
