  ...
  <mj-body background-color="#dbe5ea">
    ...
    <mj-section background-color="#126de5" padding="16px 8px 16px 8px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px">
        <mj-text align="center" font-size="30px" line-height="36px" padding-bottom="12px" color="#fff" font-weight="bold">Support Ticket Status</mj-text>
        <mj-text align="center" font-size="19px" line-height="28px" color="#EEE"> Hello, {{ ucfirst($ticketOwner->name) }}</mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#fff" padding="16px 24px 16px 24px">
      <mj-column width="100%" vertical-align="middle" padding="32px 12px 0px">
        <mj-text align="center" font-size="16px" line-height="24px" color="#424651"> Your support ticket with ID #{{ $ticket->ticket_id }} has been marked has resolved and closed.</mj-text>
      </mj-column>
    </mj-section>
